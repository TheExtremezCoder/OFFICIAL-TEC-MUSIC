                ...
                if (set.CHANNEL === message.channel.id) {
                    ...
                    if (!message.member.voice.channel) {
                        ...
                        return message.channel
                            .send({
                            content: `${message.author} <:icons_cross:1204719930046423050> | You must be connected to a voice channel`,
                        })
                            .then((x) => {
                            setTimeout(() => {
                                x.delete().catch(() => { });
                    ...
                    if (message.guild.members.me.voice.channel &&
                        ...
                        return message.channel
                            .send({
                            content: `${message.author} <:icons_cross:1204719930046423050> | You must be connected to the same voice channel ${message.guild.members.me.voice.channel}`,
                        })
                            .then((x) => {
                            setTimeout(() => {
                                x.delete().catch(() => { });
                    ...
                    if (client.commands.messages.get(message.content.trim().split(/ +/).shift().toLowerCase()) ||
                        ...
                        return message.channel
                            .send({
                            content: `<:icons_cross:1204719930046423050> | Don't use my any of the commands here <:icons:1205136577731362876>`,
                        })
                            .then((x) => {
                            setTimeout(() => {
                                x.delete().catch(() => { });
                        ...
                        if (message.content.match(this.client.spotify.spotifyPattern)) {
                            ...
                            if (res.loadType === `PLAYLIST_LOADED`) {
                                ...
                                return message.channel
                                    .send({
                                    content: `<:icons_cross:1204719930046423050> **No Results** found for the given query!`,
                                })
                                    .then((x) => {
                                    setTimeout(() => {
                                        x.delete().catch(() => { });
