            ...
            if (interaction.isButton()) {
                        ...
                        return interaction.update({
                            embeds: [
                                this.client.utils
                                    ...
                                    .setDescription(`<:icons_cross:1204719930046423050> This guild is no more a [Premium Guild](${this.client.config.voteUrl}). Visit [Support Server](${this.client.config.server}) to claim Premium`),
                            ],
                            components: [],
                        });
                        ...
                        return interaction.reply({
                            ...
                            components: [
                                this.client.utils.actionRow([
                                    this.client.utils.button(`link`, `Vote Me`, null, null, `${this.client.config.voteUrl}`, '<:Icon_Vote:1204756287389171722>'),
                                ]),
                            ],
                            ephemeral: true,
                        });
                        ...
                        return interaction.reply({
                            embeds: [
                                this.client.utils
                                    ...
                                    .setDescription(`<:icons_cross:1204719930046423050> You require **Manage Guild** permissions to use this Interaction!`),
                            ],
                            ephemeral: true,
                        });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Updated** the Player to: \`Kronix Classic Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Updated** the Player to: \`Kronix x Spotify Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Updated** the Player to: \`Kronix Simple Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Updated** the Player to: \`Kronix Special Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Updated** the Player to: \`Kronix No Buttons Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                    ...
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Updated** the Player to: \`Kronix Old School Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `oras_dj_previous`) {
                    if (this.client.utils.checkServerPrem(interaction.guild.id) === false &&
                        ...
                        interaction
                            .reply({
                            content: `<:icons_cross:1204719930046423050> This guild has **Ended its Premium Services**. So deleting this setup in 10 seconds....`,
                            ephemeral: true,
                        })
                            .then((x) => {
                            setTimeout(() => {
                    ...
                    if (!interaction.member.voice.channel &&
                        ...
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> You must be connected to a voice channel!`,
                            ephemeral: true,
                        });
                    if (interaction.member.voice.channel &&
                        interaction.guild.members.me.voice.channel &&
                        ...
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> You must be connected to the same voice channel: ${interaction.guild.members.me.voice.channel}`,
                            ephemeral: true,
                        });
                    const dispatcher = this.client.api.get(interaction.guild.id);
                    if (!dispatcher || !dispatcher.player)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> No Music Session is currently there!`,
                            ephemeral: true,
                        });
                    if (dispatcher.player.track === null)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> I am not playing anything currently`,
                            ephemeral: true,
                        });
                    if (dispatcher.previous === null)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> There is no previous song in the queue`,
                            ephemeral: true,
                        });
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Shifted** and Started playing **Previous Track**`)
                                .setTimestamp()
                ...
                if (interaction.customId === `oras_dj_stop`) {
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Stopped** the Player and **Resetted** the Queue`)
                ...
                if (interaction.customId === `oras_dj_pause`) {
                    ...
                    let b3 = this.client.utils.button(`custom_id`, null, 2, `oras_dj_pause`, null, dispatcher.player.paused
                        ...
                        : '<:icons_play:1205128619652030507>');
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **${content}** the Player`)
                ...
                if (interaction.customId === `oras_dj_loop`) {
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290> Loop Mode of the Player has been changed to **${loop}**`)
                ...
                if (interaction.customId === `oras_dj_skip`) {
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Skipped** the current track`)
                                .setTimestamp()
                                .setFooter({
                                text: `Performed By: ${interaction.user.tag}`,
                                iconURL: interaction.user.displayAvatarURL({
                ...
                if (interaction.customId === `oras_dj_volLow`) {
                    ...
                    if (volume <= 0)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> Cannot Lower down the Volume Anymore`,
                            ephemeral: true,
                        });
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Lowered** the volume to : **${volume}%**`)
                    ...
                    if (this.client.utils.findFavs(interaction.user.id, dispatcher.current) === true) {
                        ...
                        return interaction.channel
                            ...
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(interaction.guild.id)
                                    .setDescription(`<:icons_cross:1204719930046423050> Successfully **Removed** [${dispatcher.current.info.title.substring(0, 35)}](${this.client.config.voteUrl}) to **Your favourites**`)
                        ...
                        return interaction.channel
                            ...
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(interaction.guild.id)
                                    .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Added** [${dispatcher.current.info.title.substring(0, 35)}](${this.client.config.voteUrl}) to **Your Favoruites**`)
                ...
                if (interaction.customId === `oras_dj_shuffle`) {
                    ...
                    if (dispatcher.queue.length === 0)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> There are **No Songs in the Queue** to be shuffled!`,
                            ephemeral: true,
                        });
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Shuffled** the Queue of the Player`)
                                .setTitle(`Shuffled`)
                                .setTimestamp()
                                .setFooter({
                                text: `Performed By: ${interaction.user.tag}`,
                    ...
                    if (run === false)
                        return interaction.channel
                            ...
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(interaction.guild.id)
                                    .setDescription(`<:icons_cross:1204719930046423050> Successfully **Disabled** the **Autoplay** mode of the player`)
                        ...
                        return interaction.channel
                            ...
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(interaction.guild.id)
                                    .setDescription(`<:Check_Icon:1204720507623178290> Succesfully **Enabled** the **Autoplay** mode of the player`)
                                    .setTitle(`Autoplay Updated`)
                                    .setTimestamp()
                                    .setFooter({
                                    text: `Performed By: ${interaction.user.tag}`,
                ...
                if (interaction.customId === `oras_dj_volHigh`) {
                    ...
                    if (volume >= 200)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> Volume **Cannot be Increased** anymore`,
                            ephemeral: true,
                        });
                    ...
                    return interaction.channel
                        ...
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Increased** the Volume of the Player to: **${volume}%**`)
                ...
                if (interaction.customId === `oras_skip`) {
                    ...
                    if (interaction.guild.members.me.voice.channel &&
                        ...
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> You must be connected to the same voice channel as ${interaction.guild.members.me.voice.channel} to use this interaction!`,
                            ephemeral: true,
                        });
                    const dispatcher = this.client.api.get(interaction.guild.id);
                    if (!dispatcher || !dispatcher.player)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> There is no player for the guild currently!`,
                            ephemeral: true,
                        });
                    dispatcher.player.stopTrack();
                ...
                if (interaction.customId === `oras_loop`) {
                    ...
                    return interaction.reply({
                        content: `${'<:icons_loop:1205125247070900314>'} Enabled Looping Mode to: \`${loop}\``,
                        ephemeral: true,
                    });
                }
                if (interaction.customId === `oras_pause`) {
                    ...
                    if (setting === `oras-no`) {
                        let opt1 = this.client.utils.menuOption(`Reset Filters`, '<:filters:1205379624587239425>', `Resets all the filters of the player`, `oras_filter_reset`);
                        let opt2 = this.client.utils.menuOption(`8D`, '<:filters:1205379624587239425>', `Sets Up 8d filter to the player`, `oras_filter_8d`);
                        let opt3 = this.client.utils.menuOption(`BassBoost`, '<:filters:1205379624587239425>', `Sets bassboost filter to the player`, `oras_filter_bassboost`);
                        let opt4 = this.client.utils.menuOption(`NightCore`, '<:filters:1205379624587239425>', `Sets NightCore filter to the player`, `oras_filter_nightcore`);
                        let opt5 = this.client.utils.menuOption(`Vaporwave`, '<:filters:1205379624587239425>', `Sets Vaporwave filter to the player`, `oras_filter_vibrato`);
                        let options = [opt1, opt2, opt3, opt4, opt5];
                    ...
                    if (setting === `oras-special`) {
                        let b1 = this.client.utils.button(`custom_id`, null, 2, `oras_previous`, null, '<:icon_previous:1205421036829409352>');
                        let b2 = this.client.utils.button(`custom_id`, null, 2, `oras_shuffle`, null, '<:icons_shuffle:1205427370299760680>');
                        let b3 = this.client.utils.button(`custom_id`, null, 2, `oras_pause`, null, dispatcher.player.paused ? '<:icons_pause:1205426434584215596>' : '<:icons_play:1205128619652030507>');
                        let b4 = this.client.utils.button(`custom_id`, null, 2, `oras_loop`, null, '<:icons_loop:1205125247070900314>');
                        let b5 = this.client.utils.button(`custom_id`, null, 2, `oras_skip`, null, '<:icon_skip:1205426846234054686>');
                        let b6 = this.client.utils.button(`custom_id`, null, 2, `oras_volLow`, null, '<:LowVolume:1205427066896523285>');
                        let b7 = this.client.utils.button(`custom_id`, null, 2, `oras_backward`, null, '<:backward:1205453457612472364>');
                        let b8 = this.client.utils.button(`custom_id`, null, 2, `oras_stop`, null, '<:icons_stop_button:1205426251129430067>');
                        let b9 = this.client.utils.button(`custom_id`, null, 2, `oras_forward`, null, '<:forward:1205453288577961994>');
                        let b10 = this.client.utils.button(`custom_id`, null, 2, `oras_volHigh`, null, '<:HighVolume:1205427649262919730>');
                    ...
                    if (setting === `oras-simple`) {
                        ...
                        let b1 = this.client.utils.button(`custom_id`, null, 2, `oras_pause`, null, dispatcher.player.paused ? '<:icons_pause:1205426434584215596>' : '<:icons_play:1205128619652030507>');
                        let b2 = this.client.utils.button(`custom_id`, null, 2, `oras_skip`, null, '<:icon_skip:1205426846234054686>');
                        let b3 = this.client.utils.button(`custom_id`, null, 2, `oras_loop`, null, '<:icons_loop:1205125247070900314>');
                        let b4 = this.client.utils.button(`custom_id`, null, 2, `oras_stop`, null, '<:icons_stop_button:1205426251129430067>');
                    ...
                    if (setting === `oras-spotify`) {
                        ...
                        let menu = this.client.utils.menu(`Choose filters`, `help-op`, options);
                        let row1 = this.client.utils.actionRow([menu]);
                        let b1 = this.client.utils.button(`custom_id`, null, 3, `oras_previous`, null, '<:icon_previous:1205421036829409352>');
                        let b2 = this.client.utils.button(`custom_id`, null, 3, `oras_shuffle`, null, '<:icons_shuffle:1205427370299760680>');
                        let b3 = this.client.utils.button(`custom_id`, null, 3, `oras_pause`, null, dispatcher.player.paused ? '<:icons_pause:1205426434584215596>' : '<:icons_play:1205128619652030507>');
                        let b4 = this.client.utils.button(`custom_id`, null, 3, `oras_loop`, null, '<:icons_loop:1205125247070900314>');
                        let b5 = this.client.utils.button(`custom_id`, null, 3, `oras_skip`, null, '<:icon_skip:1205426846234054686>');
                        let b6 = this.client.utils.button(`custom_id`, null, 3, `oras_volLow`, null, '<:LowVolume:1205427066896523285>');
                        let b7 = this.client.utils.button(`custom_id`, null, 3, `oras_backward`, null, '<:backward:1205453457612472364>');
                        let b8 = this.client.utils.button(`custom_id`, null, 3, `oras_stop`, null, '<:icons_stop_button:1205426251129430067>');
                        let b9 = this.client.utils.button(`custom_id`, null, 3, `oras_forward`, null, '<:forward:1205453288577961994>');
                        let b10 = this.client.utils.button(`custom_id`, null, 3, `oras_volHigh`, null, '<:HighVolume:1205427649262919730>');
                ...
                if (interaction.customId === `oras_fav`) {
                    ...
                    if (this.client.utils.findFavs(interaction.user.id, dispatcher.current) === false) {
                        addFavs(interaction.user.id, dispatcher.current);
                        return interaction.reply({
                            content: `<:Check_Icon:1204720507623178290> Successfully **Added** *${dispatcher.current.info.title.substring(0, 40)}* ${this.client.config.voteUrl} to Your favs`,
                            ephemeral: true,
                        });
                    }
                    else {
                        removeFavs(interaction.user.id, dispatcher.current);
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> Successfully **Removed** *${dispatcher.current.info.title(0, 40)}* from your Favourites`,
                            ephemeral: true,
                        });
                    }
                }
                ...
                if (interaction.customId === `oras_volHigh`) {
                    ...
                    if (vol >= 200)
                        return interaction.reply({
                            content: `<:icons_cross:1204719930046423050> Cannot Increase the volume anymore!`,
                            ephemeral: true,
                        });
                    dispatcher.player.setVolume(vol / 100);
                    await interaction.deferUpdate();
                ...
                if (interaction.customId === `oras_shuffle`) {
                    ...
                    return interaction.reply({
                        content: `<:Check_Icon:1204720507623178290> Successfully **Shuffled** the queue`,
                        ephemeral: true,
                    });
                }
