        ...
        this.run = async (message) => {
            ...
            if (!message.guild.members.me
                ...
                return message.author
                    ...
                    embeds: [
                        this.client.utils
                            .embed()
                            .setDescription(`<:icons_cross:1204719930046423050> Missing **Send Messges** permissions in that channel`)
            ...
            if (!message.guild.members.me
                ...
                return message.reply({
                    content: `<:icons_cross:1204719930046423050> I am missing **Embed Links** permissions in this channel`,
                });
            if (!message.guild.members.me
                .permissionsIn(message.channel)
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .embed()
                            .setDescription(`<:icons_cross:1204719930046423050> I don't have **Read Message History** permissions in this channel`)
                            .setTitle(`Missing Permissions`),
                    ],
                });
            if (!message.guild.members.me
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            .embed()
                            .setDescription(`<:icons_cross:1204719930046423050> I don't have **Use External Emojis** permissions in this channel`)
                            .setTitle(`Missing Permissions`),
                    ],
                });
            if (this.client.utils.checkIgnore(message.guildId, message.channel.id) ===
                ...
                if (check === true &&
                    ...
                    return message
                        .reply({
                        content: `<:icons:1205136577731362876> This Channel is in my Ignore List! You cannot Run any of my Commands Here!`,
                    })
                        .then((x) => {
                        setTimeout(() => {
                            x.delete().catch(() => { });
            ...
            if (cmd.samevc) {
                if (dispatcher &&
                    ...
                    return message.reply({
                        content: `<:icons_cross:1204719930046423050> You must be connected to ${message.guild.members.me.voice.channel} to use me!`,
                    });
            }
            if (cmd.dev) {
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:icons_cross:1204719930046423050> You Server needs to be a **[Premium Guild](${this.client.config.server})** to use this command.`)
                                .setTimestamp()
                        ],
                    });
                }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setTitle(`Premium Required`)
                                .setDescription(`<:icons_cross:1204719930046423050> You need to be the **[Premium Activator](${this.client.config.server})** of this guild to use this command.`),
                        ],
                    });
                }
            }
            if (cmd.dispatcher) {
                if (!dispatcher)
                    return message.reply({
                        content: `<:icons_cross:1204719930046423050> There is no player for this guild yet!`,
                    });
            }
            if (cmd.playing) {
                if (dispatcher.player.track === null)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`<:icons_cross:1204719930046423050> The Player seems to be empty! Try adding some songs in the queue`)
