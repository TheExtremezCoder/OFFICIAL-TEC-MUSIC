                ...
                if (dispatcher && dispatcher.player) {
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`<:icons_cross:1204719930046423050> I am already Connected to ${message.guild.members.me.voice.channel.name}`),
                        ],
                    });
                }
                else {
                    ...
                    if (!message.guild.members.me
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guild.id)
                                    .setDescription(`<:icons_cross:1204719930046423050> I don't have required permissions to connect to that channel`)
                            ],
                        });
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guild.id)
                                .setDescription(`<:Check_Icon:1204720507623178290>   Successfully **Connected** to Your voice channel.`)
                        ],
                    });
                }
            }
            catch (e) {
                return message.reply({ content: `<:icons_cross:1204719930046423050> I couldn't Connect to that Voice Channel!` });
            }
        };
    }
}
