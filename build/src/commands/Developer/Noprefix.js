import { getGlobalNp, getServerNpDb } from "../../wrapper/db/prefix.js";
import OrasCommand from "../../abstract/OrasCommand.js";
import pkg from "lodash";
const { chunk } = pkg;
export default class OrasNoprefix extends OrasCommand {
    constructor(client) {
        super(client);
        this.name = "noprefix";
        this.aliases = ["nop", "np"];
        ...
        this.exec = async (message, args, prefix) => {
            if (!args[0])
                return message.reply({
                    embeds: [
                        this.client.utils
                            .embed()
                            .setDescription(`** <:white_arrow:1204737655716315178>\`${prefix}noprefix add\`\nAdds a user to the noprefix for bot\n\n<:white_arrow:1204737655716315178>\`${prefix}noprefix remove\`\nRemoves a user from noprefix of bot\n\n<:white_arrow:1204737655716315178>\`${prefix}noprefix list\`\nShows the noprefix list of the bot\n\n<:white_arrow:1204737655716315178>\`${prefix}noprefix reason\`\nReason for the noprefix of a user**`)
                            .setTitle(`<:Prefix:1204742121060438026> No Prefix Subcommands`)
                            .setTimestamp()
            ...
            if (args[0].toLowerCase() === `add`) {
                ...
                if (args[2] && args[2].toLowerCase() === `all`) {
                    if (this.client.utils.checkGlobalNp(user.id) === true)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`<:icons_cross:1204719930046423050> This User ${user} is already in my **All Server's No Prefix**`),
                            ],
                        });
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Added** ${user} to my **All Server's No Prefix**`),
                            ],
                        });
                    }
                }
                    ...
                    if (!args[2])
                        ...
                        guild = await this.client.guilds.fetch(args[2]);
                    if (!guild)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`<:icons_cross:1204719930046423050> Please provide me a valid guild!`),
                            ],
                        });
                    let id = guild.id;
                    if (this.client.utils.checkGuildNp(id, user.id) === true) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`<:icons_cross:1204719930046423050> This User ${user} is already in ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Added** ${user} to ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                }
                ...
                if (args[2] && args[2].toLowerCase() === `all`) {
                    if (this.client.utils.checkGlobalNp(user.id) === false) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`<:icons_cross:1204719930046423050> This User ${user} is not present in my **All Server's No Prefix**`),
                            ],
                        });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .successEmbed()
                                    .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Removed** ${user} from my **All Server's No Prefix**`),
                            ],
                        });
                    }
                }
                    ...
                    if (this.client.utils.checkGuildNp(guild.id, user.id) === false) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`<:icons_cross:1204719930046423050> This user ${user} is not included in ${guild.name}'s **Server No Prefix**`),
                            ],
                        });
                    }
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .successEmbed()
                                .setDescription(`<:Check_Icon:1204720507623178290> Successfully **Removed** ${user.tag} from **${guild.name}'s Server Prefix**`),
                        ],
                    });
                }
            }
            if (args[0].toLowerCase() === `list` ||
                ...
                if (args[1] && args[1].toLowerCase() === `all`) {
                    ...
                    for (let i = 0; i < list.length; i++) {
                        ...
                        lol.push(`**${i + 1}.** [${um.tag}](${this.client.config.voteUrl}) [ID: ${um.id}]`);
                    }
                    if (lol.length < 11)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    ...
                                    .setDescription(lol.length ? lol.sort().join("\n") : "No Users Provided")
                                    .setFooter({ text: `Requested By: ${message.author.tag}` }),
                            ],
                        });
                    let queue = lol.map((x) => `${x}`);
            ...
            if (args[0].toLowerCase() === 'reset') {
                if (!this.client.config.owners.includes(message.author.id))
                    ...
                    return message.reply({
                        content: `<:Check_Icon:1204720507623178290> Successfully **Resetted** The No-Prefix for the Bot!`
                    });
                }
            }
        };
