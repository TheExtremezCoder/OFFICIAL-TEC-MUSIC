                        ...
                        return interaction
                            ...
                            embeds: [
                                this.client.utils
                                    ...
                                    {
                                        name: `__Developers__`,
                                        value: `**1.** [The Extremez Coder](https://discord.gg/Yjt2EPmcWG) \n**2.** [AnimeVerse™](https://discord.gg/animeverse)`,
                                    },
                                    {
                                        name: `__Owners__`,
                                        value: `**1.** [The Extremez Coder](https://discord.gg/Yjt2EPmcWG) \n**2.** [AnimeVerse™](https://discord.gg/animeverse)`,
...
function checkMemPresence(member) {
    try {
        if (member.presence?.status === `online`)
            return "<:icon_ping:1204750281745764373>";
        else if (member.presence?.status === `idle`)
            return "<:icons_idle:1204755143141101569>";
        else if (member.presence?.status === `offline`)
            return "<:icons_offline:1204755322535809066>";
        else if (member.presence?.status === `dnd`)
            return "<:Icon_Dnd:1204755471924207616>";
        else
            return "<:icons_offline:1204755322535809066>";
    }
    catch (e) {
