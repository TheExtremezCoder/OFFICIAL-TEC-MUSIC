import { addGlobalAfk, addServerAfk } from "../../wrapper/db/premium.js";
import OrasCommand from "../../abstract/OrasCommand.js";
export default class Afk extends OrasCommand {
    constructor(client) {
        super(client);
        this.name = "afk";
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`<:icons_cross:1204719930046423050> *You discovered a [Premium Feature](${this.client.config.server}).\nYou may buy our [Premium Plan](${this.client.config.server}) to avail this feature*`)
                    ],
                });
            //
            ...
            let msg = await message.reply({
                ...
                components: [
                    this.client.utils.actionRow([
                        this.client.utils.button(`custom_id`, `Global Afk (Afk in Mutual Servers)`, 4, `global_afk`),
                        this.client.utils.button(`custom_id`, `Server Afk (Afk only in this server)`, 4, `server_afk`),
                    ]),
                ],
            });
            let collector = await msg.createMessageComponentCollector({
                filter: (b) => {
                    if (b.user.id === message.author.id)
                        ...
                        return b.reply({
                            content: `<:icons_cross:1204719930046423050> You are not the Afk Requester`,
                            ephemeral: true,
                        });
                },
                time: 100000 * 7,
